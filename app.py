...
# --- FIX SSL: Desabilita avisos de certificados autoassinados ---
...
def analyze_lead_groq(title, snippet, link, groq_key):
    ...
    if not groq_key: 
        return {"score": 0, "autor": "Desc.", "produto_recommended": "ERRO CHAVE", "argumento_venda": "Sem chave Groq"}
            ...
            if st.button("🔥 DISPARAR CAMPANHA (VIA NODE.JS LOCAL)"):
                ...
                for idx, row in df.iterrows():
                    try:
                        ...
                        # FIX SSL: verify=False ignora erro de certificado autoassinado (Self-signed certificate)
